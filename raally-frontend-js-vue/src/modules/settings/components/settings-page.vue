    ...
    <div class="app-content-page">
      ...
      >
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <app-image-upload
              ...
              v-model="model[fields.logos.name]"
            ></app-image-upload>
          </el-col>
        </el-form-item> -->
        ...
        <el-form-item
          ...
          :prop="fields.backgroundImages.name"
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <app-image-upload
              ...
              v-model="model[fields.backgroundImages.name]"
            ></app-image-upload>
          </el-col>
        </el-form-item>
...
const formSchema = new FormSchema([fields.theme, fields.backgroundImages, fields.logos]);
...
export default Vue.extend({
  ...
  components: {
    'app-settings-toolbar': SettingsToolbar,
  },
  ...
  computed: {
    ...mapGetters({
      ...
      initLoading: 'settings/initLoading',
