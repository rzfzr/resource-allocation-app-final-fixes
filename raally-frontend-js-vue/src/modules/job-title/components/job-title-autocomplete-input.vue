...
<script lang="ts">
import JobTitleFormModal from '@/modules/job-title/components/job-title-form-modal.vue';
import { JobTitlePermissions } from '@/modules/job-title/job-title-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-job-title-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-job-title-form-modal': JobTitleFormModal,
  },
