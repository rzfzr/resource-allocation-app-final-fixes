...
<script lang="ts">
import ProjectFormModal from '@/modules/project/components/project-form-modal.vue';
import { ProjectPermissions } from '@/modules/project/project-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-project-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-project-form-modal': ProjectFormModal,
  },
