...
export default Vue.extend({
  ...
  computed: {
    ...mapGetters({
      ...
      exportLoading: 'project/list/exportLoading',
  ...
  methods: {
    ...mapActions({
      doExport: 'project/list/doExport',
      doRemoveAllSelected:
        'project/list/doRemoveAllSelected',
      doDisableAllSelected:
        'project/list/doDisableAllSelected',
      doEnableAllSelected:
        'project/list/doEnableAllSelected',
