...
<script lang="ts">
import CompensationFormModal from '@/modules/compensation/components/compensation-form-modal.vue';
import { CompensationPermissions } from '@/modules/compensation/compensation-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-compensation-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-compensation-form-modal': CompensationFormModal,
  },
