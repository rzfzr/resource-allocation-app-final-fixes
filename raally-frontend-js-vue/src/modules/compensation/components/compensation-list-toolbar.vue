<template>
  <div class="app-page-toolbar">
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'compensation' },
      }"
...
export default Vue.extend({
  name: 'app-compensation-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'compensation/list/hasRows',
      loading: 'compensation/list/loading',
      exportLoading: 'compensation/list/exportLoading',
      selectedRows: 'compensation/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'compensation/list/doExport',
      doRemoveAllSelected:
        'compensation/list/doRemoveAllSelected',
      doDisableAllSelected:
        'compensation/list/doDisableAllSelected',
      doEnableAllSelected:
        'compensation/list/doEnableAllSelected',
      doDestroyAll: 'compensation/destroy/doDestroyAll',
    }),
